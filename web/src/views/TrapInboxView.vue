...
<template>
    <DashboardLayout :breadcrumbs="[{ label: 'Trap Inbox' }]">
        <template #actions>
            <span
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            {{ messages.length }} trapped messages.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
        ...
        <div class="flex flex-1 min-h-0">
            <div
                class="w-80 shrink-0 border-r border-border flex flex-col min-h-0"
            >
                <MessageList
                    :messages="messages"
                    :loading="loading"
                    :selected-id="selectedId"
                    empty-title="No trapped emails yet"
                    empty-description="Point your app at localhost:1025 and send a test email."
                    @select="onSelect"
                    @star="onStar"
                />
            </div>
